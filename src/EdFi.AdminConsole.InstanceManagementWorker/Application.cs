                ...
                else
                {
                    foreach (var instance in instances)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(instanceName))
                        {
                            ...
                            if (!await _adminApiCaller.CompleteInstanceAsync(instance.Id, instance.TenantName, new CompleteInstanceRequest() { ConnectionString = _instanceProvisioner.GetConnectionString("EdFi_Ods") }))
